...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Saboreo — Handcrafted in Zurich" },
      { property: "og:description", content: "Strawberries dressed in fine chocolate. Built to your taste, delivered same-day across Zurich." },
